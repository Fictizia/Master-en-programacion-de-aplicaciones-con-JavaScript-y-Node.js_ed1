...
var url = '/proxy?url=http://airemad.com/api/v1/pollution';
...
// GEOLOCALIZACIÓN:
  ...
  var userLatitud = "40.39172790000001"; //localStorage.getItem("Latitud"); 
  var userLongitud = "-3.7073185000000004"; //localStorage.getItem("Longitud"); 
